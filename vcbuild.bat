...
if /i "%1"=="dll"           set shared="--enable-shared"&goto arg-ok
...
python configure %download_arg% %i18n_arg% %debug_arg% %nosnapshot_arg% %noetw_arg% %noperfctr_arg% %shared% --dest-cpu=%target_arch% --tag=%TAG%
